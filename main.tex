...
\title{\textbf{Comparação entre os Métodos de Ordenação} \\ {\Large\itshape Relatório do desempenho do Bubble Sort, Insertion Sort e Selection Sort em vetores crescentes, decrescentes e aleatórios}} % Title and subtitle
